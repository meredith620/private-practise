...
CHINA_IPS=/etc/config/v2ray/dnsmasq-ipset/china_list_${CUR_DATE}.txt

rm -f /etc/config/v2ray/dnsmasq-ipset/china_list*.txt
wget https://cdn.jsdelivr.net/gh/QiuSimons/Chnroute@master/dist/chnroute/chnroute.txt -O ${CHINA_IPS}
ln -s $CHINA_IPS /etc/config/v2ray/dnsmasq-ipset/china_list.txt
