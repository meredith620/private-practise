...
#+BEGIN_SRC shell
eix-sync
sudo emerge -av -uNDU --with-bdeps=y @world
sudo emerge --depclean
sudo revdep-rebuild #emerge @preserved-rebuild
sudo eclean-dist
