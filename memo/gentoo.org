...
* packages
  ...
  + xorg-server,xbindkeys,vim,emacs,mplayer,smplayer,virtualbox-bin,firefox-bin,google-chrome-unstable,opera-developer,sawfish,git,gqview,telnet-bsd,netcat,imagemagick
